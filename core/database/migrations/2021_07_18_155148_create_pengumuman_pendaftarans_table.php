...
class CreatePengumumanPendaftaransTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pengumuman_pendaftarans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pengumuman_pendaftarans');
    }
}
